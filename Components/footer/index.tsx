...
export const Footer = () => {
  return (
    <div className="container grid grid-cols-4  pb-11 pt-11 items-center justify-center py-5 bg-black">
      ...
      <div className=" ">
        ...
        <Link
          href=""
          className="text-white text-[14px] font-normal  leading-[21,17px]"
        >
          info@bbq&kebab.com
        </Link>
